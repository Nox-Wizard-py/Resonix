...
-keep class com.noxwizard.resonix.models.PersistQueue { *; }
-keep class com.noxwizard.resonix.models.PersistPlayerState { *; }
-keep class com.noxwizard.resonix.models.QueueData { *; }
-keep class com.noxwizard.resonix.models.QueueType { *; }
-keep class com.noxwizard.resonix.playback.queues.** { *; }
