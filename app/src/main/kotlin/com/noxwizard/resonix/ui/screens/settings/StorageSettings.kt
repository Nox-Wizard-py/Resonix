...
import com.noxwizard.resonix.constants.MaxImageCacheSizeKey
import com.noxwizard.resonix.constants.MaxSongCacheSizeKey
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.noxwizard.resonix.utils.ArtworkStorage.clear(context)
            }
        }
    }
