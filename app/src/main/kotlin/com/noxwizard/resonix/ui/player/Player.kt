...
import com.noxwizard.resonix.ui.theme.PlayerBackgroundColorUtils
...
import com.noxwizard.resonix.constants.QueuePeekHeight
            ...
            when (playerDesignStyle) {
                ...
                PlayerDesignStyle.EXPRESSIVE -> {
                    ...
                    Column(
                        ...
                        // Main controls row: circle prev | dark pill play/pause | circle next
                        Row(
                            modifier = Modifier.fillMaxWidth(),
                            horizontalArrangement = Arrangement.Center,
                            verticalAlignment = Alignment.CenterVertically
                        ) {
                            // Previous — circular light button
                            Surface(
                                onClick = { playerConnection.seekToPrevious() },
                                enabled = canSkipPrevious,
                                shape = CircleShape,
