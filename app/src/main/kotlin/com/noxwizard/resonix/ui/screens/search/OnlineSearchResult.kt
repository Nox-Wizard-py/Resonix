package com.noxwizard.resonix.ui.screens.search
...
import com.noxwizard.resonix.innertube.YouTube.SearchFilter.Companion.FILTER_ALBUM
import com.noxwizard.resonix.innertube.YouTube.SearchFilter.Companion.FILTER_ARTIST
import com.noxwizard.resonix.innertube.YouTube.SearchFilter.Companion.FILTER_COMMUNITY_PLAYLIST
import com.noxwizard.resonix.innertube.YouTube.SearchFilter.Companion.FILTER_FEATURED_PLAYLIST
import com.noxwizard.resonix.innertube.YouTube.SearchFilter.Companion.FILTER_SONG
import com.noxwizard.resonix.innertube.YouTube.SearchFilter.Companion.FILTER_VIDEO
...
import com.noxwizard.resonix.constants.SearchFilterHeight
...
import com.noxwizard.resonix.viewmodels.OnlineSearchViewModel
...
fun OnlineSearchResult(
    ...
    LaunchedEffect(viewModel.autoPlay, searchSummary) {
        if (viewModel.autoPlay && searchSummary != null) {
            val firstSong = searchSummary.summaries
                .flatMap { it.items }
